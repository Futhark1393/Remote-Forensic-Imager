# Author: Futhark1393
# Description: Main GUI module for Remote Forensic Imager v2.1.
# Features Paramiko integration, E01/RAW chunk-based streaming, on-the-fly hashing, and Material UI.
...
class ForensicApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Remote Forensic Imager v2.1 (Enterprise Edition)")
    ...
    def setup_terminal_style(self):
        ...
        # Background adapted to fit the material theme smoothly.
        ...
        self.log("[*] Forensic Console Initialized (v2.1 - Enterprise UI).")
    ...
    def start_process(self):
        ...
        self.log("\n--- [ STARTING FORENSIC ACQUISITION (v2.1) ] ---")
    ...
    def generate_txt_report(self, sha256_hash, md5_hash, filepath):
        ...
        report_content = f"""
================================================================
            DIGITAL FORENSIC ACQUISITION REPORT (v2.1)
================================================================
CASE DETAILS:
-------------
...
if __name__ == "__main__":
    ...
    # Apply the dark teal material theme for enterprise look
